...
$\theta_{\mathrm{det}}=30\tcdegree$とし、$\theta_\mathrm{wire}=0\tcdegree,\,15\tcdegree,\,60\tcdegree$に対して時系列データを生成した。
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\columnwidth]{wiregrid/wiregrid_calibration_circle.pdf}
    \caption{較正円のイメージ}
