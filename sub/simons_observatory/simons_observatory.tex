...
\begin{equation}
    ...
    \end{split}
\end{equation}
である。この式はその偏光角をほとんど時間変化しない$(\Omega\sim0)$ 信号 $Q_{\mathrm{in}}+iU_{\mathrm{in}}$ がHWPを通過することで、
周波数 $\pm 4\omega_{\mathrm{HWP}}$ のところに変調されることを示している。
...
天球面上においてどの向きに偏光角を持ってを較正する絶対角度較正が存在する。
