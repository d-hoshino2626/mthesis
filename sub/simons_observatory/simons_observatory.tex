...
転移点近傍の温度に制御された超伝導物質に吸収体を接続すると、光子が入射してきた場合に吸収体が光子を熱に変換し、超伝導物質を温める。
これによりその温度が転移点を超え、超伝導物質の電気抵抗が急激に増加するような装置、すなわちボロメータを作ることができる。
このような装置はTESボロメータ（Transition Edge Sensor）と呼ばれる。

焦点面検出器には、TESボロメータが使用されている。
