...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        スケーラ & 大西測定株式会社 & 140-1000B \\
        カメラ & Basler & acA1920-155um \\
        レンズ & Computar & M0814-MP2 \\
        LEDテープライト & & \\
        スパースワイヤーグリッド & & \\
        アクチュエータ & Openbuilds & V-Slot NEMA 23 Linear Actuator (Belt Driven) \\
        アクチュエータ & Openbuilds & V-Slot NEMA 17 Linear Actuator (Belt Driven) \\
        モーションコントローラ & Galil & DMC-4020 \\
        ステッピングモーター & Openbuilds & NEMA 23 Stepper Motor - High Torque Series \\
        \hline
\end{table}
\subsection{評価原理}
