...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{wiresag_swg/swg_sag_angle_before_even_odd.pdf}
...
これによって張り直されたワイヤーのたわみ量が$0.025\tcdegree$程度に抑えられれば、たわみ角の平均値は$0.015\tcdegree$程度に改善できる。
